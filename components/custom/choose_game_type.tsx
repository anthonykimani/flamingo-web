    ...
    return (
        <div className="flex flex-col justify-around items-center h-full sm:h-1/2">
            ...
            <div className="flex flex-col sm:flex-row justify-center w-full">
                ...
                <Button showComingSoon disabled onClick={onComplete} variant={"active"} size={"gametype"}><StrategyIcon size={32} />Team Building</Button>
                <Button showComingSoon disabled onClick={onComplete} variant={"active"} size={"gametype"}><RankingIcon size={32} />Degen PvP</Button>
            </div>
