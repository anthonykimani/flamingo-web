  ...
  "border-2 border-slate-800 border-b-6 border-r-6 h-9 w-full min-w-0 rounded-xl bg-white px-3 text-sm shadow-xs transition-[color,box-shadow] outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-lg ",
  {
    variants: {
      variant: {
        ...
        title: "h-14 w-full text-center text-xl md:text-2xl placeholder:font-bold",
        question: "h-[110px] w-full text-center text-xl xsm:text-2xl placeholder:text-xl xsm:placeholder:text-2xl placeholder:font-bold",
        answer: "h-[110px] w-full text-center text-xl xsm:text-2xl placeholder:text-xl xsm:placeholder:text-2xl placeholder:font-bold",
        generate: "h-[110px] w-full text-center text-2xl md:text-2xl placeholder:text-md placeholder:text-2xl placeholder:font-bold"
      }
    }
  }
)
